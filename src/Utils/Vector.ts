export class Vector2D {
    ...
    public mult(vec: Vector2D): Vector2D {
        return new Vector2D(this.x * vec.x, this.y * vec.y);
    }
    public div(vec: Vector2D): Vector2D {
        return new Vector2D(this.x / vec.x, this.y / vec.y);
    }
...
export class Vector3D {
    ...
    public sub(vec: Vector3D): Vector3D {
        return new Vector3D(this.x - vec.x, this.y - vec.y, this.z - vec.z);
    }

    public mult(vec: Vector3D): Vector3D {
        return new Vector3D(this.x * vec.x, this.y * vec.y, this.z * vec.z);
    }
    public div(vec: Vector3D): Vector3D {
        return new Vector3D(this.x / vec.x, this.y / vec.y, this.z / vec.z);
    }
